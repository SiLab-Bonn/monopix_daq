...
def analyze_raw_data(input_file, output_file_hits):
    with AnalyzeRawData(raw_data_file=input_file, analyzed_data_file=output_file_hits, create_pdf=True) as analyze_raw_data:
        ...
        analyze_raw_data.create_empty_event_hits = True  # creates events with no hist in hit table
        ...
        analyze_raw_data.trigger_data_format = 2  # specify trigger data word format
...
if __name__ == "__main__":
    ...
    output_file_hits = input_file[:-3] + "_interpreted.h5"
