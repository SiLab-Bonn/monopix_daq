...
#                         break
        ...
        pulser['Pulser'].set_voltage(INJ_LO, INJ_LO + injection, unit='V')
        ...
        for inx, delay in enumerate(delay_scan_range):
            ...
            pulser['Pulser'].set_trigger_delay(delay*1E-9) # from s to ns (check http://literature.cdn.keysight.com/litweb/pdf/33250-90007.pdf page 5)
