...
#        self.dut['data_rx'].CONF_STOP_FREEZE = 127
#        self.dut['data_rx'].CONF_STOP_READ = 94
#        self.dut['data_rx'].CONF_STOP = 137
#
#        self.dut['data_rx'].CONF_START_FREEZE = 50
#        self.dut['data_rx'].CONF_START_READ = 52
#        self.dut['data_rx'].CONF_STOP_FREEZE = 87
#        self.dut['data_rx'].CONF_STOP_READ = 54
#        self.dut['data_rx'].CONF_STOP = 100
#        
#        print "AFTER:"
#        print self.dut['data_rx'].CONF_START_FREEZE
#        print self.dut['data_rx'].CONF_START_READ
        ...
        if scan_injection:
            for inx, vol in enumerate(inj_scan_range):
                ...
                with self.readout(scan_param_id=inx, fill_buffer=True, clear_buffer=True):
                    ...
                    self.dut['data_rx'].CONF_START_FREEZE = 50
                    self.dut['data_rx'].CONF_START_READ = 52
                    self.dut['data_rx'].CONF_STOP_FREEZE = 88
                    self.dut['data_rx'].CONF_STOP_READ = 54
                    self.dut['data_rx'].CONF_STOP = 100
...
if __name__ == "__main__":
    ...
    scan = ScanSingle(dut_extentions=m_ex)
